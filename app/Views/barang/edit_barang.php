          ...
          <div class="row justify-content-center">
            <div class="col-md-6">
              <div class="card ">
                ...
                <div class="card-body ">
                  <form method="post" action="<?= base_url('dashboard/barang/edit') . '/' . $barang['id'] ?>" id="createBarang">
                    <div class="form-group">
                      <label class="bmd-label-floating" for="kode_barang">Kode Barang</label>
                    ...
                    <div class="form-group">
                      <label class="bmd-label-floating" for="satuan">Satuan</label>
                    ...
                    <div class="form-group">
                      <label class="bmd-label-floating" for="harga">Harga</label>
                    ...
                    <div class="form-group">
                      <label class="bmd-label-floating" for="stok">Stok</label>
