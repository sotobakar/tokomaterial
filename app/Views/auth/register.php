...
<?php session()->set('redirect_url', base_url(route_to('/'))) ?>
    ...
    <div class="collapse navbar-collapse justify-content-end">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a href="<?= base_url(route_to('register')) ?>" class="nav-link">
            <i class="material-icons">person_add</i>
            Register
          </a>
        </li>
        <li class="nav-item ">
          <a href="<?= base_url(route_to('login')) ?>" class="nav-link">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
          <form class="form" method="post" action="<?= base_url(route_to('register')) ?>">
              ...
              <div class="card-body ">
                ...
                <span class="bmd-form-group">
                  <div class="input-group">
                    ...
                    <input name="pass_confirm" type="password" class="form-control" placeholder="Confirm Password">
                  </div>
                </span>
              </div>
    ...
    <footer class="footer">
      <div class="container">
        <div class="copyright float-right">
          ...
          </script>, made by Patrick Santino
